...
proc import datafile="<Insert-Folder-Path>\grpi_lonmart_imputed.csv"
			out=lonmart_data
			replace;
run;
...
proc export data=grpi_laspeyres 
			outfile="<Insert-Folder-Path>\grpi_lonmart_laspeyres.xls"
			replace;
run;

proc export data=grpi_paasche 
			outfile="<Insert-Folder-Path>\grpi_lonmart_paasche.xls"
			replace;
run;

proc export data=grpi_alltypes
			outfile="<Insert-Folder-Path>\grpi_lonmart_imputation.xls"
			replace;
run;
