...
proc import datafile="<Insert-Folder-Path>\rpi_lonmart_imputed.csv"
			out=lonmart_data
			replace;
run;
...
proc export data=rpi_laspeyres 
			outfile="<Insert-Folder-Path>\rpi_lonmart_laspeyres.xls"
			replace;
run;

proc export data=rpi_paasche 
			outfile="<Insert-Folder-Path>\rpi_lonmart_paasche.xls"
			replace;
run;

proc export data=rpi_alltypes
			outfile="<Insert-Folder-Path>\rpi_lonmart_imputation.xls"
			replace;
run;
