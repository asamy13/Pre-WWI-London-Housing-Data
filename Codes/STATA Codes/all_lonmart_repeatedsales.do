...
insheet using "<Insert-Folder-Path>\lonmart_repeatsales_1895_1914.csv";
...
esttab using "<Insert-Folder-Path>\londonmart_regcoeffs_repeatsales.csv", plain not scalars(r2) replace;